...
2) Import the reference to these files inside the appropriate html file such as index.html. 
   The Configuration.js file should be imported before the other files.
    ...
    <!-- Models -->
    <script src="scripts/DigitalNewzealandLib/Models/BaseModel.js"></script>
    <script src="scripts/DigitalNewzealandLib/Models/ResultsCollection.js"></script>
    <script src="scripts/DigitalNewzealandLib/Models/CollectionSearchRecords.js"></script>
